...
export default [
  {
    ignores: ['node_modules/**', 'coverage/**', 'mochawesome-report/**', 'dist/**'],
  },

  {
    ...
    languageOptions: {
      ...
      sourceType: 'module',
      globals: {
        ...globals.node,   // Node.js globals (require, module, process, etc.)
  ...
  // 2. Mocha-specific configuration (from eslint-plugin-mocha)
...
// Override for Babel config (use CommonJS mode)
  {
